...
// Keeping these in sync with backend/app/schemas/*.py is manual for now;
// in a bigger project we'd auto-generate from the OpenAPI spec.
...
export interface GameSummary {
  ...
  // WebSocket message types — discriminated union by `type` field.
  ...
  export type WSMessage = WSConnected | WSTick | WSGameEnd | WSError;